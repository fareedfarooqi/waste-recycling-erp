...
const ClientViewModal: React.FC<ClientModalProps> = ({ isOpen, client, onClose }) => {
    ...
    return (
        ...
        >
            ...
            <div>
                ...
                <p><strong>Phone No: </strong>{client.contact_details?.phone || "N/A"}</p>
                <p><strong>Email: </strong>{client.contact_details?.email || "N/A"}</p>
                <p><strong>Address: </strong>{client.contact_details?.address || "N/A"}</p>
