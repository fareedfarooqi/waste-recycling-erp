...
// import { FaEye, FaPlus, FaEdit, FaTrashAlt, FaAngleLeft, FaAngleRight, FaAngleDoubleLeft, FaAngleDoubleRight, FaSort } from 'react-icons/fa';
...
//     const handleSortChange = (field: string, direction: 'asc' | 'desc' | 'default') => {
//         setSortField(field);
...
// // const sortedItems = getSortedItems(filteredPickups);
// // const currentItems = sortedItems.slice(startIndex, endIndex);

// // const getSortedItems = (items: PickupItem[]) => {
// //     if (sortDirection === 'default') return items;
...
// // Update the currentItems calculation in your component:
// // const sortedItems = getSortedItems(filteredPickups);
// // const currentItems = sortedItems.slice(startIndex, endIndex);
...
//             case 'completed':
//                 return { label: 'Completed', color: 'bg-[#c6efcd] border border-[#4caf50]' };
//             case 'scheduled':
//                 return {
//                     label: 'Scheduled',
...
//                 };
//             default:
//                 return { label: 'Unknown', color: 'bg-[#ffc8ce] border border-[#f44336]' };
//         }
//     };
...
//                         <span>Driver Pickup Screen</span>
//                     </div>
//                     }
//                     variant="primary"
//                     onClick={() => {}} // Empty function to satisfy TypeScript
//                     className="flex items-center justify-center px-4 py-2 text-sm font-bold bg-green-600 text-white rounded hover:bg-green-700 transition whitespace-nowrap min-w-[120px]"
//                 />
//                 </Link>
...
//                 <tr>
//                   <th className="text-xl font-bold px-6 py-8 text-center">Pickup ID</th>
//                   <th className="text-xl font-bold px-6 py-8 text-center">Customer Name</th>
//                   <th className="text-xl font-bold px-6 py-8 text-center">Pickup Location</th>
//                   <th className="text-xl font-bold px-6 py-8 text-center">Scheduled Date & Time</th>
//                   <th className="text-xl font-bold px-6 py-8 text-center">Bins</th>
//                   <th className="text-xl font-bold px-6 py-8 text-center">Status</th>
//                   <th className="text-xl font-bold px-6 py-8 text-center">Actions</th>
//                 </tr>
//               </thead>
//               <tbody>
//                 {currentItems.map((item) => {
//                   const { label, color } = getStatusStyle(item.status);
//                   return (
//                     <tr key={item.id} className="hover:bg-gray-100 even:bg-gray-100 odd:bg-white">
//                       <td className="text-base px-6 py-4 border-b text-center">{item.id}</td>
//                       <td className="text-base px-6 py-4 border-b text-center">{item.company_name}</td>
//                       <td className="text-base px-6 py-4 border-b text-center">{item.pickup_location.address}</td>
//                       <td className="text-base px-6 py-4 border-b text-center">
//                         {new Date(item.pickup_date).toLocaleString()}
//                         {/* <DateFormatter date={item.pickup_date} /> */}
//                       </td>
//                       <td className="text-base px-6 py-4 border-b text-center">{item.empty_bins_delivered}</td>
//                       <td className="text-base px-6 py-4 border-b text-center">
            ...
            >
                ...
                <span> Add Pickup</span>
                        ...
                        <Button
                            ...
                            variant="primary"
                            onClick={() => router.push('/pickup/add-pickup')}
                            className="flex items-center justify-center px-4 py-2 text-sm font-bold bg-green-600 text-white rounded hover:bg-green-700 transition whitespace-nowrap min-w-[120px]"
                        />
