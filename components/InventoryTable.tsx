...
const InventoryTable = (): JSX.Element => {
    ...
    const handleDateFilter = (date: string) => {
        ...
        const filteredData = inventory.filter((item) => {
            ...
            const formattedItemDate = itemDate.toISOString().slice(0, 10); // Ensure the format is "YYYY-MM-DD"
            ...
            <div className="w-11/12 overflow-x-auto border rounded-lg shadow-lg">
                <div className="flex justify-between items-center p-4 space-x-4">
                    ...
                    <Button
                        ...
                        variant="primary"
                        onClick={() => router.push('/add-product')} // Use router.push to navigate to the AddProductPage
                        icon={<FaPlus />}
                        className="flex items-center px-4 py-2 text-sm"
                    />
                </div>
                                ...
                                <td className="px-6 py-4">
                                    <div className="flex justify-center space-x-4">
                                        ...
                                        <FaEdit
                                            ...
                                            } // Navigate to edit page using router.push
                                        />
                                        <FaTrashAlt
