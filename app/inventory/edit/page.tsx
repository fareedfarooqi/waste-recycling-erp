import { FaSearch, FaPencilAlt, FaCog, FaQuestion, FaBox, FaCalendarAlt, FaUsers } from "react-icons/fa";
        ...
        <div className="flex-grow bg-green-50 p-12">
          <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg border border-gray-200">
            ...
            <div className="mb-8">
              ...
              <p className="text-lg font-light text-green-600">Edit new products</p>
            </div>
