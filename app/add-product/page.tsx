    ...
    const handleSaveProduct = async () => {
        ...
        if (existingProducts?.length > 0) {
            ...
            const { error: updateError } = await supabase
                .from('products')
                .update({
                    quantity: parseFloat(existingProduct.quantity) + parseFloat(quantity),
                    product_description: description || existingProduct.product_description,
                    reserved_location: reservedLocation || existingProduct.reserved_location,
                    ...
                    <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg border border-gray-200">
                        ...
                        <form>
                            ...
                            <FormField
                                ...
                                placeholder="Enter reserved location"
                                value={formValues.reservedLocation}
                                onChange={(e) => handleInputChange('reservedLocation', e.target.value)}
                            />
                            <div className="flex justify-between mt-8">
                                <Button label="Cancel" variant="secondary" onClick={() => console.log('Cancel clicked')} />
                                <Button
                                    label="Save Product"
                                    variant="primary"
